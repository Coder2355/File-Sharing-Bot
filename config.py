...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "https://t.me/+pyhMKcJks6JlNTA1"))

TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "4"))

#start message
START_MSG = os.environ.get("START_MESSAGE", "Hello Friends {first}\n\nI can store private files of Anime warrior Channel and other users can access it from special link.")
try:
    ADMINS=[6299192020]
...
#Force sub message 
FORCE_MSG = os.environ.get("FORCE_SUB_MESSAGE", "Hello Friend {first}\n\n<b>You need to join in my Channel to use me\n\nKindly Please join Channel</b>")
...
USER_REPLY_TEXT = "❌Don't send me messages directly I'm only File Share bot of Anime warrior!"
